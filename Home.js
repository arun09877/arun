...
// // Define SlidePanel component
// const SlidePanel = ({ isOpen, onClose }) => (
//   <SlidePanelContainer style={{ transform: isOpen ? 'translateX(0)' : 'translateX(-100%)' }}>
//     <SlidePanelContent>
//       <Button onClick={onClose}>Close Slide Panel</Button>
//       {/* Add your slide panel content here */}
...
//         Signup
//       </AuthButton>
//       <ExploreButton component={Link} to="/explore">
//         Explore
//       </ExploreButton>
//     </SlidePanelContent>
//   </SlidePanelContainer>
  ...
  return (
    <div>
      ...
      <Footer>
        ...
        <FooterIcon>
          <a href="https://www.facebook.com/profile.php?id=100027798282864"><FaFacebook /> Facebook</a>
        </FooterIcon>
        <FooterIcon>
